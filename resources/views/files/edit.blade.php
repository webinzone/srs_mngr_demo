...
<div id="webui">
    ...
    <div class="row">
        ...
        <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1 col-sm-12 col-sm-offset-0">
         ...
         <form id="create-form" class="form-horizontal" method="post" action = "{{ route ('files.update', $file->id) }}" autocomplete="off" role="form" >
            @method('PATCH') 
            ...
            <div class="box box-default">
               ...
               <div class="box-body">                           
                 ...
                 <input type="text" name="user_name" class="form-control" value="{{ $file->user_name}}">
                 ...
                 <input type="text" name="title" class="form-control" value="{{ $file->title}}">                                        
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-md-7 col-sm-12 required">
                 <input type="text" name="desc" class="form-control" value="{{ $file->desc}}">                                       
                        </div>
                    </div>
                    <div class="form-group ">
